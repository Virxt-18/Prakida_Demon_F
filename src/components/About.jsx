  ...
  const pillars = [
    {
      icon: Shield,
      title: "DISCIPLINE",
      desc: "Forged through rigorous training.",
    },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="text-prakida-water font-bold tracking-widest text-lg">
                ABOUT THE FEST
              </h2>
            </div>
            <h3 className="text-4xl md:text-5xl font-display font-bold text-white mb-8 leading-tight">
              Where Sportsmanship Meets{" "}
              <span className="text-prakida-flame">The Hashira Spirit</span>
            </h3>
            <p className="text-gray-400 text-lg leading-relaxed mb-6">
              PRAKRIDA is not just a sports fest; it's a battleground where
              potential meets opportunity. Inspired by the legendary Demon
              Slayer Corps, we bring you an arena where every athlete channels
              the strength, speed, and precision of the Hashira.
            </p>
            <p className="text-gray-400 text-lg leading-relaxed">
              Join us for 3 days of intense competition, camaraderie, and
              celebration. Whether you strike like lightning or flow like water,
              this is your stage to ascend.
            </p>
          </motion.div>
