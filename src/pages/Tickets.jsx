...
const Tickets = () => {
  ...
  const handlePurchase = async () => {
    ...
    try {
      ...
      await ticketService.updateBookingUid(
        ticket.id,
            ...
            <div className="relative bg-black border border-white/10 rounded-lg p-8 aspect-[4/5] flex flex-col justify-between overflow-hidden">
              ...
              <div className="relative z-10 flex justify-between items-end">
                <div>
                  ...
                  <p className="text-prakida-flame font-bold">
                    {EVENT_DETAILS.venue}
                  </p>
                </div>
                <Zap
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Experience the climax of Prakida '26. A night of electrifying
                performances, thumping bass, and the unity of thousands. Don't
                miss the biggest cultural extravaganza of the year.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-purple-900/20 to-prakida-flame/20 border border-white/10 p-6 rounded-lg flex flex-col md:flex-row justify-between items-center gap-6">
              <div>
                ...
                <div className="text-xs text-green-400 flex items-center gap-1 mt-1">
                  <Star size={10} className="fill-current" /> Limited
                  Availability
                </div>
              </div>
